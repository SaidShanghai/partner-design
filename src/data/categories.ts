...
export const categoriesData: Record<string, CategoryData> = {
  ...
  "jacquards-habillement": {
    ...
    products: [
      ...
      { image: "jacquard-paisley-camel", name: "Jacquard Paisley Camel & Marine", price: "17,50 €", unit: "le mètre" },
      { image: "jacquard-damasse-rose", name: "Jacquard Damassé Rose Poudré", price: "16,90 €", unit: "le mètre" },
      { image: "jacquard-artdeco-emeraude", name: "Jacquard Art Déco Émeraude Argenté", price: "18,90 €", unit: "le mètre", badge: "Nouveauté" },
      { image: "jacquard-feuilles-moutarde", name: "Jacquard Feuilles Moutarde Écru", price: "15,50 €", unit: "le mètre" },
      { image: "jacquard-chevron-gris", name: "Jacquard Chevron Gris Chiné", price: "14,90 €", unit: "le mètre", variants: "3 coloris" },
      { image: "jacquard-medaillon-bleucanard", name: "Jacquard Médaillon Bleu Canard", price: "17,90 €", unit: "le mètre" },
    ],
    seo: {
  ...
  burlington: {
    ...
    parentName: "Tissu Habillement",
    shortDescription:
      "Le tissu Burlington est un incontournable pour les déguisements, nappes et créations décoratives. Infroissable, léger et disponible dans une large palette de couleurs vives.",
    filters: ["COULEUR", "LAIZE", "PLUS DE FILTRES"],
    products: [
      { image: "burlington-vert-foret", name: "Burlington Vert Sapin", price: "5,90 €", unit: "le mètre", variants: "30 coloris" },
      { image: "burlington-bleu-marine", name: "Burlington Bleu Marine", price: "5,90 €", unit: "le mètre", variants: "30 coloris" },
      { image: "burlington-rouge", name: "Burlington Rouge Vif", price: "5,90 €", unit: "le mètre", variants: "30 coloris" },
      { image: "burlington-violet", name: "Burlington Violet Intense", price: "5,90 €", unit: "le mètre", variants: "30 coloris" },
      { image: "burlington-vert-anis", name: "Burlington Vert Anis Fluo", price: "5,90 €", unit: "le mètre", variants: "30 coloris" },
      { image: "burlington-turquoise", name: "Burlington Turquoise", price: "5,90 €", unit: "le mètre", variants: "30 coloris" },
      { image: "burlington-noir", name: "Burlington Noir", price: "5,90 €", unit: "le mètre", variants: "30 coloris" },
      { image: "burlington-blanc", name: "Burlington Blanc", price: "5,90 €", unit: "le mètre", variants: "30 coloris" },
      { image: "burlington-beige", name: "Burlington Beige Sable", price: "5,90 €", unit: "le mètre", variants: "30 coloris" },
      { image: "burlington-corail", name: "Burlington Corail", price: "5,90 €", unit: "le mètre", variants: "30 coloris" },
      { image: "burlington-bordeaux", name: "Burlington Bordeaux", price: "5,90 €", unit: "le mètre", variants: "30 coloris" },
      { image: "burlington-vert-foret", name: "Burlington Vert Émeraude", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-bleu-marine", name: "Burlington Bleu Nuit", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-rouge", name: "Burlington Rouge Cerise", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-violet", name: "Burlington Aubergine", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-corail", name: "Burlington Rose Bonbon", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-turquoise", name: "Burlington Bleu Vert Lagon", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-beige", name: "Burlington Pêche", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-blanc", name: "Burlington Ivoire", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-bordeaux", name: "Burlington Prune", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-vert-anis", name: "Burlington Vert Pomme", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-noir", name: "Burlington Anthracite", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-bleu-marine", name: "Burlington Bleu Roi", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-rouge", name: "Burlington Coquelicot", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-corail", name: "Burlington Saumon", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-vert-foret", name: "Burlington Kaki", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-beige", name: "Burlington Caramel", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-turquoise", name: "Burlington Menthe", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-violet", name: "Burlington Mauve", price: "5,90 €", unit: "le mètre" },
      { image: "burlington-bordeaux", name: "Burlington Marsala", price: "5,90 €", unit: "le mètre" },
    ],
    seo: {
      title: "Tissu Burlington : Couleurs Vives et Polyvalence",
      paragraphs: [
        "Le <strong>tissu Burlington</strong> est un polyester léger, infroissable et facile d'entretien. Grâce à sa large palette de couleurs vives et unies, il est le tissu de prédilection pour les déguisements, costumes de scène, nappes et décorations événementielles.",
        "Disponible en laize de 150 cm, le Burlington se coud facilement et ne s'effiloche presque pas. Son prix accessible en fait un choix économique pour les grandes métrages.",
        "Associez-le avec du <a href='/categorie/satin' class='text-primary hover:underline'>satin</a> pour des finitions brillantes ou de la <a href='/categorie/broderie-anglaise' class='text-primary hover:underline'>broderie anglaise</a> pour un contraste texturé original.",
      ],
    },
  },
};
